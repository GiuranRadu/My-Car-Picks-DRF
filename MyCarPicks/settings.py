"""
Django settings for MyCarPicks project.
...
SECRET_KEY = 'django-insecure-if^j!v+9=1=#m3_92)*wt39^p1@+s(6y$xzgn4(aq^1l@sa9n5'
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": (
        "rest_framework.permissions.IsAuthenticated",   # implicit: totul cere login-> implicit este AllowAny
    ),
...
WSGI_APPLICATION = 'MyCarPicks.wsgi.application'
